...
function App() { 
  ...
  const [carNo, setCarNo] = useState('15号車(5555)');
  ...
  const cars=["15号車(5555)","16号車(6666)","17号車(7777)","18号車(8888)"]
  ...
  return (
    ...
    <Grid className="grd" container direction="column">
      ...
      <Grid item container spacing={2}>
        <Grid item sm={1}/>
        <Grid item sm={1}>
          <Button><Link to="/App"><h3>前のページへ</h3></Link></Button>
        </Grid>
        <Grid item sm={2}>
        <label>号車　　</label>
              ...
              >
                <MenuItem value={"15号車(5555)"}>15号車(5555)</MenuItem>
                <MenuItem value={"16号車(6666)"}>16号車(6666)</MenuItem>
                <MenuItem value={"17号車(7777)"}>17号車(7777)</MenuItem>
                <MenuItem value={"18号車(8888)"}>18号車(8888)</MenuItem>
